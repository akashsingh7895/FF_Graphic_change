...
public class MainActivity extends AppCompatActivity implements MaxAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       binding.graphic.setOnClickListener(new View.OnClickListener() {
           @Override
       ...
       binding.resolution.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               ...
               if (interstitialAd.isReady()){
                   interstitialAd.showAd();
                   startActivity(new Intent(MainActivity.this,ResolutionActivity.class));
